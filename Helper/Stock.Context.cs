...
namespace Helper
{
    ...
    public partial class stockEntities : DbContext
    {
        ...
        public virtual DbSet<weekly_analysis> weekly_analysis { get; set; }
        ...
        public virtual DbSet<daily_raw> daily_raw { get; set; }
        ...
        public virtual int process_weekly(Nullable<System.DateTime> dttm)
        {
            var dttmParameter = dttm.HasValue ?
                new ObjectParameter("dttm", dttm) :
                new ObjectParameter("dttm", typeof(System.DateTime));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("process_weekly", dttmParameter);
        }
    
        public virtual int process_weekly_chg(Nullable<System.DateTime> dttm)
        {
            var dttmParameter = dttm.HasValue ?
                new ObjectParameter("dttm", dttm) :
                new ObjectParameter("dttm", typeof(System.DateTime));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("process_weekly_chg", dttmParameter);
        }
    
        public virtual ObjectResult<filter_01_process_Result> filter_01_process(Nullable<System.DateTime> v_day_start, string v_param1, string v_param2, string v_param3, string v_param4, string v_param5)
        {
            var v_day_startParameter = v_day_start.HasValue ?
                new ObjectParameter("v_day_start", v_day_start) :
                new ObjectParameter("v_day_start", typeof(System.DateTime));
    
            var v_param1Parameter = v_param1 != null ?
                new ObjectParameter("v_param1", v_param1) :
                new ObjectParameter("v_param1", typeof(string));
    
            var v_param2Parameter = v_param2 != null ?
                new ObjectParameter("v_param2", v_param2) :
                new ObjectParameter("v_param2", typeof(string));
    
            var v_param3Parameter = v_param3 != null ?
                new ObjectParameter("v_param3", v_param3) :
                new ObjectParameter("v_param3", typeof(string));
    
            var v_param4Parameter = v_param4 != null ?
                new ObjectParameter("v_param4", v_param4) :
                new ObjectParameter("v_param4", typeof(string));
    
            var v_param5Parameter = v_param5 != null ?
                new ObjectParameter("v_param5", v_param5) :
                new ObjectParameter("v_param5", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<filter_01_process_Result>("filter_01_process", v_day_startParameter, v_param1Parameter, v_param2Parameter, v_param3Parameter, v_param4Parameter, v_param5Parameter);
        }
    
        public virtual ObjectResult<sp_next_n_days_Result> sp_next_n_days(string symbol, Nullable<System.DateTime> start_date, Nullable<int> days)
        {
            var symbolParameter = symbol != null ?
                new ObjectParameter("symbol", symbol) :
                new ObjectParameter("symbol", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_next_n_days_Result>("sp_next_n_days", symbolParameter, start_dateParameter, daysParameter);
        }
    
        public virtual int sp_simulation1(string symbols, Nullable<System.DateTime> start_dttm, Nullable<double> sell_limit_perc, Nullable<int> max_days_hold)
        {
            var symbolsParameter = symbols != null ?
                new ObjectParameter("symbols", symbols) :
                new ObjectParameter("symbols", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_simulation1", symbolsParameter, start_dttmParameter, sell_limit_percParameter, max_days_holdParameter);
        }
    
        public virtual ObjectResult<filter_main1_Result> filter_main1(Nullable<System.DateTime> start_dttm, Nullable<System.DateTime> end_dttm, Nullable<int> option, string passing_list, string passing_symbols, string att1, string att2, string att3, string att4, string att5, string is_simul)
        {
            var start_dttmParameter = start_dttm.HasValue ?
                new ObjectParameter("start_dttm", start_dttm) :
                new ObjectParameter("start_dttm", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<filter_main1_Result>("filter_main1", start_dttmParameter, end_dttmParameter, optionParameter, passing_listParameter, passing_symbolsParameter, att1Parameter, att2Parameter, att3Parameter, att4Parameter, att5Parameter, is_simulParameter);
        }
    
        public virtual int filter_simul1(Nullable<System.DateTime> start_dttm, Nullable<System.DateTime> end_dttm)
        {
            var start_dttmParameter = start_dttm.HasValue ?
                new ObjectParameter("start_dttm", start_dttm) :
                new ObjectParameter("start_dttm", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("filter_simul1", start_dttmParameter, end_dttmParameter);
        }
    
        public virtual ObjectResult<option_011_Result> option_011(Nullable<System.DateTime> start_dttm, Nullable<System.DateTime> end_dttm, string passing_list, string att1, string att2, string att3, string att4, string att5)
        {
            var start_dttmParameter = start_dttm.HasValue ?
                new ObjectParameter("start_dttm", start_dttm) :
                new ObjectParameter("start_dttm", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<option_011_Result>("option_011", start_dttmParameter, end_dttmParameter, passing_listParameter, att1Parameter, att2Parameter, att3Parameter, att4Parameter, att5Parameter);
        }
    }
}
