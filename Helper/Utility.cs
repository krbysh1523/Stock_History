...
namespace Helper
{
    ...
    public static class Utility
    {
        ...
        public static LineSeries AddLine(List<daily_analysis> _hist, int _sma,
            ...
            )
        {
            ...
            foreach (var h in _hist)
            {
                if (_sma == 1)
                    ...
                    sma_points.Add(Math.Round(h.sma5.Value, 2));
                else if (_sma == 8)
                    sma_points.Add(Math.Round(h.sma8.Value, 2));
                else if (_sma == 15)
                    sma_points.Add(Math.Round(h.sma15.Value, 2));
                else if (_sma == 20)
                    sma_points.Add(Math.Round(h.sma20.Value, 2));
                else if (_sma == 33)
                    sma_points.Add(Math.Round(h.sma33.Value, 2));
                else if (_sma == 45)
                    sma_points.Add(Math.Round(h.sma45.Value, 2));
                else if (_sma == 60)
                    sma_points.Add(Math.Round(h.sma60.Value, 2));
                else if (_sma == 150)
                    sma_points.Add(Math.Round(h.sma150.Value, 2));
                else if (_sma == 200)
                    sma_points.Add(Math.Round(h.sma200.Value, 2));
            }
        ...
        public static void GetXLabels(AxesCollection _x, List<daily_analysis> _hist)
        {
            Axis x = new Axis();
            List<string> labels = new List<string>();
            foreach (var h in _hist)
        ...
        public static LineSeries AddStraightLine(List<daily_analysis> _hist, double _value, System.Windows.Media.Color _color, string _title)
        {
            LineSeries line = new LineSeries();
            line.Stroke = new System.Windows.Media.SolidColorBrush(_color);
            line.StrokeDashArray = new System.Windows.Media.DoubleCollection(new double[] { 1 });
