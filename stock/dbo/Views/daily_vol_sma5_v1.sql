...
-- Alter View daily_vol_sma5_v1


CREATE VIEW [dbo].[daily_vol_sma5_v1]
AS
     SELECT h1.symbol, 
            ...
            h1.sma5, 
            h1.sma5_pre, 
            case when h1.sma5_pre is null or h1.sma5_pre = 0 then null
            else ROUND(((h1.sma5 - h1.sma5_pre) / h1.sma5_pre) * 100, 2) end AS sma5_chg_perc
     FROM
     (
         SELECT h.symbol, 
                h.[date], 
